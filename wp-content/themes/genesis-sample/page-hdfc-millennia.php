...
add_action('wp_head', function() {
    $card_name = 'HDFC Millennia Credit Card';
    $card_description = 'HDFC Millennia Credit Card offers 5% cashback on online shopping, 2.5% on online payments, 1% on offline. ₹1,000 annual fee. Best online shopping card 2025.';
    $annual_fee = '₹1,000';
    ...
    echo '<title>' . $card_name . ' - 5% Online Shopping Cashback Review & Apply 2025 | CardAdvisorHub</title>';
    echo '<meta name="description" content="' . $card_description . '">';
    echo '<meta name="keywords" content="HDFC Millennia Credit Card, online shopping cashback, digital payments, HDFC Bank, millennials card">';
    echo '<meta name="robots" content="index, follow">';
    
    // Open Graph Tags
    echo '<meta property="og:title" content="' . $card_name . ' - Best Online Shopping Card 2025">';
    echo '<meta property="og:description" content="' . $card_description . '">';
    echo '<meta property="og:type" content="product">';
    echo '<meta property="og:url" content="' . get_permalink() . '">';
    echo '<meta property="og:image" content="' . get_template_directory_uri() . '/images/hdfc-millennia-card.jpg">';
    echo '<meta property="og:site_name" content="CardAdvisorHub">';
    
    // Twitter Card Tags
    echo '<meta name="twitter:card" content="summary_large_image">';
    echo '<meta name="twitter:title" content="' . $card_name . ' - Online Shopping">';
    echo '<meta name="twitter:description" content="' . $card_description . '">';
    echo '<meta name="twitter:image" content="' . get_template_directory_uri() . '/images/hdfc-millennia-card.jpg">';
    ...
    $schema = array(
        ...
        'image' => get_template_directory_uri() . '/images/hdfc-millennia-card.jpg',
        'brand' => array(
            '@type' => 'Brand',
            'name' => $bank_name
        ),
        'offers' => array(
            '@type' => 'Offer',
            'description' => 'Premium cashback credit card for online shopping',
